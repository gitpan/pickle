...
implicitly on the "current" interpreter, so the Interpreter object is
generally not used.  You can cause Perl to shut down and free its
...
official Perl distribution.  For other licensing arrangements, contact
the author.
